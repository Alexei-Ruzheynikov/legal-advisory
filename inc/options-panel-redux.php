...
$opt_name = 'legal_advisory';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::setSection( $opt_name, array(
		...
		'desc'            =>  esc_html__( 'Add links profiles for Social', 'legal-advisory' ),
		'fields'          => array(
			array(
				'id'              => 'social_links',
				'type'            => 'sortable',
				'title'           => esc_html__( 'Social Links', 'legal-advisory' ),
				'subtitle'        => esc_html__( 'Inser Links for your Social Profiles', 'legal-advisory' ),
				'desc'            => esc_html__( 'Let the field empty if you don\'t have a link', 'legal-advisory' ),
				'label'           => true,
				'options'         => array(
					'Vkontakte Link' => '',
					'Facebook Link'  => '',
