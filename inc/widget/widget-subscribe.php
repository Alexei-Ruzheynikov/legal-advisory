 ...
 * Blog Widget 
 */
class Legal_advisory_Subscribe_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		/* Widget settings. */
		$widget_ops = array(
			'classname' => 'legal_advisory_subscribe_widget', 
		...
		$control_ops = array(
			'width'		=> 500, 
			'height'	=> 450, 
			'id_base'	=> 'legal_advisory_subscribe_widget' 
		);

		/* Create the widget. */
		parent::__construct( 'legal_advisory_subscribe_widget', 'Legal_advisory | Подписка', $widget_ops, $control_ops );
	}
