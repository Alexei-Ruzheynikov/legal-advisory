 ...
 * Blog Widget 
 */
class Legal_advisory_Customsearch_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		/* Widget settings. */
		$widget_ops = array(
			'classname' => 'legal_advisory_customsearch_widget', 
		...
		$control_ops = array(
			'width'		=> 500, 
			'height'	=> 450, 
			'id_base'	=> 'legal_advisory_customsearch_widget' 
		);

		/* Create the widget. */
		parent::__construct( 'legal_advisory_customsearch_widget', 'Legal_advisory | Персональный поиск', $widget_ops, $control_ops );
	}
	...
	public function form( $instance ) 
	{
		...
		$defaults = array(
			'custom_placeholder'		=> 'Поиск о новостям',
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'custom_placeholder' ); ?>">Что внтури поиска</label>
