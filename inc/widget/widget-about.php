 ...
 * Blog Widget 
 */
class Legal_advisory_About_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		/* Widget settings. */
		$widget_ops = array(
			'classname' => 'legal_advisory_about_widget', 
		...
		$control_ops = array(
			'width'		=> 500, 
			'height'	=> 450, 
			'id_base'	=> 'legal_advisory_about_widget' 
		);

		/* Create the widget. */
		parent::__construct( 'legal_advisory_about_widget', 'Legal_advisory | О компании', $widget_ops, $control_ops );
	}
