...
<section class="inner events">
    <div class="wrapper">
        <div class="news">
            <h2 class="news__title secondary-title"><span><?php echo $legal_advisory['newstitle1']; ?></span><br><?php echo $legal_advisory['newstitle2']; ?></h2>
            ...
            if($news->have_posts() ) :
                ...
                <?php if($news->max_num_pages > 1){ ?>
                    <nav class="pagination">
                        <div class="nav-links">
                            <?php 
                            // Выводим левую стрелку для 1 страница
